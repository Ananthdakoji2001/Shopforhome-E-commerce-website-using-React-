            ...
            {products.map((p, i) => (
              ...
              >
                ...
                <Link to={`/admin/product/update/${p._id}`}>
                  <span  style={{marginRight:20,marginLeft:20}}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-wrench-adjustable-circle-fill" viewBox="0 0 16 16">

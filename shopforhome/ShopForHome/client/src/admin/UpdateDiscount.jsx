...
const UpdateUser = ({ match }) => {
  ...
  const redirectUser = (success) => {
    if (success) {
      return <Redirect to='/admin/ManageDiscount' />;
    }
  };
  ...
  const profileUpdate = (name,discount_coupon) => (
    ...
    <h2 className='mb-4 text-center'>Discount Coupon Update</h2>
...
<div className='row'>
      <div className='col-md-3'>{adminLinks()}</div>
        <div className='col-md-9'>{profileUpdate(name, discount_coupon)}
